...
{
    public class ObservableCollectionVM<M> : ObservableCollection<IViewModel<M>>//Klasa u sustini radi sinhronizaciju
    {
        ...
        protected override void InsertItem(int index, IViewModel<M> item) //Ovo je flag za ubacivanje i regulise pucanje ako dodje do njega
        {
