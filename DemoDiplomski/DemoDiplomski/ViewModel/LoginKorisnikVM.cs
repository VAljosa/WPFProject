...
{
    public class LoginKorisnikVM : ViewModelObject<Login_Korisnik>, IDataErrorInfo
    {

        private Login_Korisnik logKorisnik;

        public Login_Korisnik LogKorisnik
        {
            get
            {
                return logKorisnik;
        ...
        public LoginKorisnikVM(Login_Korisnik model)
             : base(model)
        {
